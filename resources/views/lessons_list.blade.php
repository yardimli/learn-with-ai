				...
				<div class="modal-body">
					<div id="generationOptionsArea">
						...
						<div id="generationSourceGroup" class="mb-3 border rounded p-2 d-none">
							...
							<div class="form-check">
								<input class="form-check-input" type="radio" name="generationSource" id="sourceSubject" value="subject"
								       checked>
								<label class="form-check-label" for="sourceSubject"> Use Subject & Notes </label>
							</div>
							<div class="form-check">
								<input class="form-check-input" type="radio" name="generationSource" id="sourceVideo" value="video">
								<label class="form-check-label" for="sourceVideo"> Use Video Subtitles </label>
							</div>
						</div>
						...
						<div id="autoDetectCheckboxArea" class="mb-3 form-check">
							...
							<label class="form-check-label" for="autoDetectCategoryCheck"> Auto-detect category based on
								content </label>
						</div>
				...
				<form id="addVideoForm">
					...
					<div class="modal-body">
						...
						<div id="addVideoProgress" class="text-primary d-none mt-3">
							<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Processing... This
							might take a minute or two depending on video size.
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
						<button type="submit" class="btn btn-primary" id="submitVideoButton">
							<span id="submitVideoSpinner" class="spinner-border spinner-border-sm d-none" role="status"
							      aria-hidden="true"></span>
